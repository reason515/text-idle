...
export const MAGE_LEVEL_SKILLS = {
  5: [
    { id: 'arcane-missiles', name: '奥术飞弹', spec: '奥术', manaCost: 18, cooldown: 0, coefficient: 1.0, effectDesc: '1.0 倍伤害，恢复造成伤害 10% 的法力' },
    { id: 'frost-nova', name: '冰霜新星', spec: '冰霜', manaCost: 20, cooldown: 2, coefficient: 0.5, targets: -1, effectDesc: '对所有造成 0.5 倍伤害，-20% 敏捷 2 回合，2 回合 CD' },
    { id: 'flamestrike', name: '烈焰风暴', spec: '火焰', manaCost: 25, cooldown: 2, coefficient: 0.55, targets: -1, effectDesc: '对所有造成 0.55 倍伤害 + 燃烧 2 回合，2 回合 CD' },
  ],
  10: [
    { id: 'polymorph', name: '变形术', spec: '奥术', manaCost: 25, cooldown: 3, effectDesc: '目标 2 回合无法行动，受击解除，3 回合 CD' },
    { id: 'cone-of-cold', name: '冰锥术', spec: '冰霜', manaCost: 18, cooldown: 0, coefficient: 0.7, targets: 2, effectDesc: '对 2 个目标造成 0.7 倍伤害，抗性 -4 持续 2 回合' },
    { id: 'scorch', name: '灼烧', spec: '火焰', manaCost: 12, cooldown: 0, coefficient: 1.0, effectDesc: '1.0 倍伤害，低消耗填充；目标有燃烧时 +0.2 倍' },
  ],
  15: [
    { id: 'counterspell', name: '法术反制', spec: '奥术', manaCost: 0, cooldown: 4, effectDesc: '本回合打断目标，4 回合 CD' },
    { id: 'ice-lance', name: '冰枪术', spec: '冰霜', manaCost: 10, cooldown: 0, coefficient: 1.0, effectDesc: '1.0 倍伤害，目标有冰霜 debuff 时 1.5 倍' },
    { id: 'pyroblast', name: '炎爆术', spec: '火焰', manaCost: 35, cooldown: 2, coefficient: 1.8, effectDesc: '1.8 倍伤害，2 回合 CD' },
  ],
  20: [
    { id: 'arcane-barrage', name: '奥术弹幕', spec: '奥术', manaCost: 30, cooldown: 1, coefficient: 1.6, effectDesc: '1.6 倍伤害，暴击：-30% 治疗 2 回合，1 回合 CD' },
    { id: 'blizzard', name: '暴风雪', spec: '冰霜', manaCost: 28, cooldown: 2, coefficient: 0.45, targets: -1, effectDesc: '对所有造成 0.45 倍伤害，-25% 敏捷 2 回合，2 回合 CD' },
  ...
  25: [
    ...
    { id: 'frost-armor', name: '冰甲术', spec: '冰霜', manaCost: 15, cooldown: 0, effectDesc: '友方受到伤害 -15% 持续 4 回合' },
    { id: 'dragons-breath', name: '龙息术', spec: '火焰', manaCost: 22, cooldown: 3, coefficient: 0.9, targets: 2, effectDesc: '对 2 个目标造成 0.9 倍伤害，眩晕 1 回合，3 回合 CD' },
  ],
  30: [
    { id: 'evocation', name: '唤醒', spec: '奥术', manaCost: 0, cooldown: 6, effectDesc: '恢复 40% 最大法力，本回合无法造成伤害，6 回合 CD' },
    { id: 'deep-freeze', name: '深度冻结', spec: '冰霜', manaCost: 30, cooldown: 4, coefficient: 1.5, effectDesc: '1.5 倍伤害，眩晕 1 回合，仅对冰霜 debuff 目标，4 回合 CD' },
  ...
  35: [
    ...
    { id: 'ice-barrier', name: '寒冰护体', spec: '冰霜', manaCost: 20, cooldown: 4, effectDesc: '友方吸收下次攻击 50% 伤害，4 回合 CD' },
    { id: 'hot-streak', name: '炽热连击', spec: '火焰', manaCost: 0, cooldown: 0, effectDesc: '被动：连续 2 次火焰暴击 = 下次炎爆免费且无 CD' },
  ],
  40: [
    { id: 'arcane-intellect', name: '奥术智慧', spec: '奥术', manaCost: 10, cooldown: 0, effectDesc: '所有友方 SpellPower +15% 持续 5 回合' },
  ...
  45: [
    ...
    { id: 'molten-armor', name: '熔岩护甲', spec: '火焰', manaCost: 15, cooldown: 0, effectDesc: '友方受到物理伤害 -10% 持续 4 回合' },
  ],
  50: [
  ...
  60: [
    { id: 'arcane-storm', name: '奥术风暴', spec: '奥术', manaCost: 40, cooldown: 5, coefficient: 0.75, targets: -1, effectDesc: '对所有造成 0.75 倍伤害，无视 25% 抗性，2 回合，5 回合 CD' },
