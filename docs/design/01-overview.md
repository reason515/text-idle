...
- **组建 (Assemble)**: 角色获取与队伍构成
	- 队伍规模：初始固定战法牧三人组（战士、法师、牧师），每人 2 个固定初始技能；通关第 1 张地图 BOSS 后**限定招募德鲁伊**（第 4 人，固定 2 技能，等级与小队最低等级一致）；通关第 2 张地图 BOSS 后可招募第 5 人（自选职业，**固定 2 初始技能**，等级与小队最低等级一致），最终最多 5 人。
	- 第 4 人德鲁伊无职业与技能选择，直接进入属性分配；第 5 人扩展招募时玩家选择英雄，**无**初始技能选择步（专精在 Lv10 学新池三选一）。
...
- **分析 (Analyze)**: 战斗日志与数据统计
	- 通过实时战斗面板与挂机收益统计，评估策略效率、定位短板，为优化提供依据；详细指标、清零规则与展示规范见 [13-player-statistics.md](./13-player-statistics.md)。
...
- **战斗系统 (Combat System)**（详见 [03-combat.md](./03-combat.md)）
	...
	- **战后数据统计**: 统计**仅按步**（战斗行动步、休息步、探索步），**无按回合比率**；可按每 10/100 步展示；按英雄与技能下钻、实际暴击/命中/闪避等，详见 [13-player-statistics.md](./13-player-statistics.md)
...
- **关卡与内容 (Levels & Content)**（详见 [02-levels-monsters.md](./02-levels-monsters.md)）
	...
	- **英雄席位**: 初始固定 **3 人**（战法牧）；击败第 1、2 张地图 BOSS 后各可招募 **1 名**扩展英雄，最多 **5 人**（详见 [02-levels-monsters.md](./02-levels-monsters.md) 1.2）
