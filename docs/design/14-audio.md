...
| 怪物目标切换（`monsterTargetIntent` / 非冗余 `ot`）… | `monsterTargetSwitch` | `fs_monster_target_switch.ogg` | 短 swoosh + 轻微下行 ping |
