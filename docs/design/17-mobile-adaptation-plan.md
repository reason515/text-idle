...
> **状态：8.1 ✅ 完成（2026-08-07）**
>
> - 8.1 ✅ **全量回归**：桌面全量 **131/135**，4 个失败全部既有（combat-flow:608 阶段 0 基线就有、combat-flow:593 组跑 flake 单跑过、message-board 409 与 shop buy 均 stash 验证过）——**无移动端适配引入的回归**。移动冒烟 6/6 × 2 project。
> - 8.2 ⏳ 发布记录（版本说明加移动端）
> - 8.3 ⏳ 设计文档复核（design-change-impact 检查表）
