...
| 法师 | DPS | 火球术、奥术冲击 | 火焰 + 奥术双系基础输出 |
| 牧师 | 治疗 | 快速治疗、真言术：盾 | 单体治疗 + 套盾吸收伤害 |

- **起始装备**：每人一件 **普通（白）** 品质 **主手武器** 与 **胸甲**（底材与掉落表一致，取等级 1 普通层；战士为短刀，法师与牧师为权杖，胸甲为布甲；数值为区间中档，无词缀），避免裸装开局过弱。
- **技能成长**：三人组从 **5 级** 起触发技能选择（加强已有或学习新技能），与 [05-skills.md](./05-skills.md) 四一致。
- **1–4 级**：仅使用上述 2 个固定技能，无技能选择窗口。
...
|----------|----------------|--------------|--------------|
| 击败第 1 张地图 BOSS（如 Hogger） | 5 级 | 20 点（1→5 共 4 次升级 × 5 点） | 1. 选择英雄 2. 分配属性点 3. 选择初始技能（3 选 1）4. 完成 5 级技能选择（加强或学新） |
