...
| AC5c | Druid levels from 9 to 10 (or resolves Lv 10 milestone during 4th-hero recruitment)      | Level-up or onboarding milestone is triggered                                       | Modal for **Lv 10** shows Druid learn options: Bear Form (Guardian), Regrowth (Restoration), Rake (Feral, **single target**)                                                                                        |
