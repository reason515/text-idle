...
- **Recruitment flow (5th hero, Druid)**: (1) Confirm Malfurion (only option); (2) Allocate catch-up attribute points; (3) **No** skill pick — fixed Rejuvenation + Maul; (4) **Optional** skill milestones (skippable).
