...
| Check | Affected areas | Notes |
|-------|----------------|-------|
| **Skill milestone enhance caps / UI level** | [05-skills.md](design/05-skills.md) 4.1, 4.3, 8.1.6, 8.2.6, 8.3.2, **8.4.4–8.4.5**, **8.5.1–8.5.2**; MainScreen hero detail Skills tab (inline choice panel, enhancement ladder, red-dot badges); battle log `skillMilestoneHint` | `skillEnhancementLimits.js`, `skillEnhancementLadder.js`, `skillChoice.js`, `SkillChoicePanel.vue`, `*Skills.js` enhance formulas; badge `Lv.x/5` |
